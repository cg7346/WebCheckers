...
//        boolean canMove = game.canPieceMove(startMove.getRow(), startMove.getCol());
//        System.out.println("Can Move " + canMove );
//        if (canMove) {
//            boolean isEmptyBlack = game.isValid(endMove.getRow(), endMove.getCol());
//            if (!isEmptyBlack) {
//                return false;
//            }
...
//                if (isEmptyBlack) {
//                    game.enableDisableMove(startMove.getRow(), startMove.getCol(), false);
//                    return true;
//                }
//            }
